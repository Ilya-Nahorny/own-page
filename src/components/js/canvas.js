...
window.onload = function()
{
    ...
    //universeRadiusDefined = screenWidth/4;
		...
		bgGradient.addColorStop(0.8, '#2a2a2a');
...
function renderPoints()
{
	...
	for(i; i > -1; --i)
	{
		...
		var px = point.x * scale*2 + (screenWidth / 2);
		var py = point.y * scale*2 + (screenHeight / 2);
...
function drawPoint(point, scale)
{
  ...
  //if (TrajectoryRadius > universeRadiusDefined){
	...
	context.fillStyle = '#04aecca8';
	}else{
	//render meteorites as black
	context.fillStyle = '#008a9cb6';
	}
	context.beginPath();
